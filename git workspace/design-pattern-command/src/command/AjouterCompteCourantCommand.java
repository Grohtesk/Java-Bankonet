...
public class AjouterCompteCourantCommand extends IhmCommand {
	...
	public AjouterCompteCourantCommand(Scanner sc, ClientService clientService, CompteService compteService) {
		this.sc = sc;
	...
	public void execute() {
		...
		compteService.ajouterCompteCourant(client,numero,intitule,solde,montantDecouvetAutorise);
	}
